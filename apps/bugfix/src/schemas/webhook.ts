...
/**
 * Payload the Jira Automation "Send web request" action must deliver.
 * Lenient on list fields because Jira smart values often render lists as
 * comma-separated strings.
 */
export const jiraWebhookPayloadSchema = z.object({
  phase: z.literal("analyze").default("analyze"),
